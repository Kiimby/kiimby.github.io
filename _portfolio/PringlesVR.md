---
layout: single
title:  "Pringles Asset for Roller Coaster"
date: 2026-04-15
order: 22
header:
...
{% capture fig_img %}
![Foo]({{ "/assets/images/Portfolio/PringlesVR/PringlesR1.png" | relative_url }})
{% endcapture %}

<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>Pringles bottle front view</figcaption>
</figure>

[//]: <> (Pringles Render2)

{% capture fig_img %}
![Foo]({{ "/assets/images/Portfolio/PringlesVR/PringlesR2.png" | relative_url }})
{% endcapture %}
