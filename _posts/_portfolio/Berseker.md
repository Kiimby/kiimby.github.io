...
{% capture fig_img %}
![Foo]({{ "/assets/images/Portfolio/Berseker/BersekerRender.jpg" | relative_url }})
{% endcapture %}
...
{% capture fig_img %}
![Foo]({{ "/assets/images/Portfolio/Berseker/BersekerHighpoly.jpg" | relative_url }})
{% endcapture %}

<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>Highpoly model</figcaption>
</figure>

[//]: <> (Views)

{% capture fig_img %}
![Foo]({{ "/assets/images/Portfolio/Berseker/BersekerViews.jpg" | relative_url }})
{% endcapture %}
